...
let drawnNumbers = [];
let players = {}; // Armazena jogadores { socketId: 'Nome do Jogador' }
let gameStarted = false;
let gameInterval; // Variável para o temporizador
...
function startGame() {
    ...
    // Sorteio automático a cada 5 segundos
...
function drawNumber() {
    ...
    // CORREÇÃO: Envia o novo número sorteado para TODOS os clientes.
...
io.on('connection', (socket) => {
    ...
    socket.emit('estado_inicial', {
        drawn: drawnNumbers,
        // CORREÇÃO: Usa o operador ternário para evitar 'undefined' se o array estiver vazio
...
}); // <--- Fechamento correto de io.on('connection', ...)
